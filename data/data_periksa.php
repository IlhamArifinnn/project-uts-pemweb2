...
<body>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="../form/form_periksa.php"><button class="btn btn-primary mb-1">Tambah Data</button></a>
                                <table class="table table-head-fixed table-responsive-lg table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td>
                                            <a href='../view/view_periksa.php?id=" . $row['id'] . "' class='btn btn-success btn-sm mr-2 mb-2'>View</a>
                                            <a href='../update/update_periksa.php?id=" . $row['id'] . "' class='btn btn-info btn-sm mr-2 mb-2'>Update</a>
                            ...
                            <div class="card-footer">
                                <p class="mb-0 fst-italic text-secondary">Keterangan ID:</p>
                                <ul class="text-secondary">
                                    <li>Id Pasien diperoleh dari data pasien</li>
                                    <li>Id Dokter diperoleh dari data paramedik</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function confirmDelete(id) {
            ...
            if (result) {
                window.location = '../delete/delete.php?table=periksa&id=' + id;
            }
            return false;
        }
    </script>
